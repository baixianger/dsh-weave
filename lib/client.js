      ...
      function WeaveSettings() {
        ...
        return h("div", { style: { width: "min(720px, 100%)", padding: "8px 4px 48px" } },
          ...
          h("section", null,
            ...
            h("div", { style: { display: "grid", gap: 8 } }, endpoints.map((endpoint) => h("div", { key: endpoint.hostId, style: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, padding: "11px 12px", borderRadius: 10, background: "var(--dsw-alias-bg-layer-2, #f6f7f8)" } }, h("span", { style: { overflow: "hidden", textOverflow: "ellipsis", fontFamily: "ui-monospace, monospace", fontSize: 12 } }, endpoint.hostId), h("small", { style: { color: endpoint.addressKnown ? "var(--dsw-alias-color-primary, #5870d8)" : "var(--dsw-alias-text-secondary, #777)" } }, endpoint.addressKnown ? "Ready" : "Pair again")))),
